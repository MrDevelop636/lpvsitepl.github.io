...
<a href="index.php">
  ...
  <?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
      ...
      file_put_contents('content.txt', $content1.PHP_EOL.$content2.PHP_EOL.$content3.PHP_EOL.$content4.PHP_EOL.$content5.PHP_EOL.$content6.PHP_EOL.$content7.PHP_EOL.$content8.PHP_EOL.$content9.PHP_EOL.$content10.PHP_EOL.$content11);
